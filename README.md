...
* Configuration
  ...
  It is possible to specify configuration file with ```certbot-auto --config cli.ini``` (or shorter ```certbot-auto -c cli.ini```).

  My config file is in ```/etc/letsencrypt/cli.ini```, which is the default searching location:
  ```
  ...
  email = erictang@tangcongyuan.com

  # Uncomment and update to generate certificates for the specified
  # domains.
  domains = tangcongyuan.com, www.tangcongyuan.com
  ...
  webroot-path = /home/ubuntu/tangcongyuan_com/DjangoOnAWS/tangcongyuan_com
  ```
